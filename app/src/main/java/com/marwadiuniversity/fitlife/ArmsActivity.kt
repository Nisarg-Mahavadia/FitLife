...
class ArmsActivity : BaseActivity() {
    ...
    private fun loadUserGender() {
        ...
        firestore.collection("users")
            ...
            .addOnSuccessListener { doc ->
                userGender = (doc.getString("gender") ?: "other").lowercase()
        ...
        firestore.collection("exercises")
            ...
            .addOnSuccessListener { result ->
                ...
                for (document in result) {
                    ...
                    itemView.findViewById<TextView>(R.id.tvExerciseName).text = name
                    itemView.findViewById<TextView>(R.id.tvTimer).text = "$duration sec"
                ...
                btnStart.setOnClickListener {
                    ...
                    intent.putExtra("exerciseCategory", "Arms")
            ...
            .addOnFailureListener { e ->
                Log.e("Firestore", "Error loading Arms", e)
