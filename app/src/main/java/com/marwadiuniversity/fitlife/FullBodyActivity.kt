...
class FullBodyActivity : BaseActivity() {
    ...
    private fun loadUserGender() {
        ...
        firestore.collection("users")
            ...
            .addOnFailureListener {
                Toast.makeText(this, "Failed to fetch gender!", Toast.LENGTH_SHORT).show()
            }
    }
        ...
        firestore.collection("exercises")
            ...
            .addOnSuccessListener { result ->
                ...
                for (document in result) {
                    ...
                    val applicable =
                        document.get("applicable_for") as? List<*> ?: listOf("male", "female")
                ...
                btnStart.setOnClickListener {
                    ...
                    intent.putExtra("exerciseCategory", "FullBody")
            ...
            .addOnFailureListener { e ->
                Log.e("Firestore", "Error loading Full Body", e)
